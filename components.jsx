    ...
    <nav className="site-nav" style={{ background: scrolled ? 'rgba(10,10,10,0.94)' : 'rgba(10,10,10,0.75)', height: "90px" }}>
      <div className="nav-left">
        <a href="#" className="nav-wordmark" aria-label="Cre8 Your Success">
          <img src="assets/logo-horizontal.png" alt="Cre8 Your Success" style={{ display: 'block', height: "80px" }} />
        </a>
          ...
          <li className="nav-item has-dropdown">
            ...
            <div className="nav-dropdown">
              <div className="nav-dropdown-inner">
                ...
                <a href="workflow-automation.html">Workflow Automation</a>
              </div>
            </div>
          </li>
      ...
      <div className="container">
        ...
        <div className="feat-grid">
          ...
          <div className="feat lg voice-card" style={{ backgroundColor: "rgb(6, 8, 11)" }}>
            ...
            <div className="voice-card-grid">
              <div className="voice-card-left">
                ...
                <p>Pick up every call in the first ring. Qualify leads, book appointments, handle FAQs, and hand off to a human when it matters — in a voice trained on your brand. <a href="voice-agents.html" style={{color:'var(--orange)',fontWeight:700,textDecoration:'none'}}>See Voice Agents →</a></p>
              ...
              <div className="voice-card-video">
                <video autoPlay loop muted playsInline>
                  <source src="assets/voice-agent.mp4" type="video/mp4" />
                </video>
          ...
          <div className="feat sm" style={{ backgroundColor: "rgb(6, 8, 11)" }}>
            ...
            <p>Consistent, automated lead flow without chasing. Capture, qualify, and follow up in seconds. <a href="lead-generation.html" style={{color:'var(--orange)',fontWeight:700,textDecoration:'none'}}>Explore →</a></p>
          ...
          <div className="feat sm2" style={{ backgroundColor: "rgb(6, 8, 11)" }}>
            ...
            <p>Remove manual work and scale operations across the tools you already use. <a href="workflow-automation.html" style={{color:'var(--orange)',fontWeight:700,textDecoration:'none'}}>Explore →</a></p>
            <div className="integrations" style={{paddingTop:14}}>
      ...
      <div className="footer-grid">
        <div className="footer-brand">
          <div className="footer-logo">
            <img src="assets/logo-horizontal.png" alt="Cre8 Your Success" style={{ height: 44, display: 'block' }} />
          </div>
        ...
        <div className="footer-col">
          <h4>Services</h4>
          <ul>
            <li><a href="voice-agents.html">Voice Agents</a></li>
            <li><a href="lead-generation.html">Lead Generation</a></li>
            <li><a href="workflow-automation.html">Workflow Automation</a></li>
          </ul>
        </div>
        <div className="footer-col">
          <h4>Company</h4>
